...
public class EnemyBasicMeleeAttack : MonoBehaviour
{
    ...
    {
        if ((other.gameObject.GetComponent<Building>() || other.gameObject.GetComponent<MainBuilding>()) && other.gameObject.GetComponent<HealthComponent>()) //This might be performance taxing
        {
